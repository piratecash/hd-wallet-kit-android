...
class HDWalletTest {
    ...
    fun privateKey() {
        ...
        assertContentEquals(hdKey1.chainCode, hdKey2.chainCode)
    }
    ...
    fun testBatchPublicKeysGeneration() {
        ...
        publicKeys.forEachIndexed { index, pubKey ->
            assertContentEquals(pubKey.publicKey, batchPublicKeys[index].publicKey)
        }
    }
    ...
    fun hdWalletFromAccountXpub() {
        ...
        assertEquals(null, wifCompressed(privateKey.privateKeyOrNull))
    }
    ...
    private fun wifCompressed(privateKey: ByteArray?): String? {
        ...
        val addrChecksum = doubleSHA256.copyOfRange(0, 4)
